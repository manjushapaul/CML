...
export const metadata: Metadata = {
  title: 'PsychicOz Mobile Application Case Study | Code Meld Labs',
  description: 'Comprehensive cross-platform mobile application built with React Native connecting users with psychic readers for spiritual consultations.',
  openGraph: {
    title: 'PsychicOz Mobile Application Case Study | Code Meld Labs',
    description: 'Cross-platform mobile app with real-time chat, video calling, and comprehensive psychic discovery',
    images: ['/images/psy.png'],
  },
}

export default function PsychicozMobCaseStudyPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <CaseStudyHero data={psychicozMobCaseStudy} />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="space-y-4 text-gray-600">
                <div>
                  ...
                  <p>{psychicozMobCaseStudy.overview.client}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Problem</h3>
                  <p>{psychicozMobCaseStudy.overview.problem}</p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Goals</h3>
                  <ul className="space-y-2">
                    {psychicozMobCaseStudy.overview.goals.map((goal, index) => (
            ...
            <div className="lg:col-span-1">
              <CaseStudyMeta data={psychicozMobCaseStudy} />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Gallery */}
      <CaseStudyGallery images={psychicozMobCaseStudy.gallery} />

      {/* Features Section */}
      {psychicozMobCaseStudy.features && (
        <CaseStudySection title="Features" className="bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {psychicozMobCaseStudy.features.map((feature, index) => (
                <div
                  key={index}
      ...
      <CaseStudySection title="Process & Decisions">
        <div className="space-y-6">
          {psychicozMobCaseStudy.process.map((step, index) => (
            <div
              key={index}
      ...
      <CaseStudySection title="Results & Learnings" className="bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">{psychicozMobCaseStudy.results.title}</h3>
          <ul className="space-y-3">
            {psychicozMobCaseStudy.results.bullets.map((bullet, index) => (
